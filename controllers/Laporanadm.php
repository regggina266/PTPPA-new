...
class Laporanadm extends CI_Controller
{
    ...
    public function edit($idlaporan)
    {
        ...
        {
            // Fetch 'nama' from 'akun' based on 'idakun'
           /* $idakun = $this->input->post('idakun');
            ...
            if ($query->num_rows() > 0) {
                $result = $query->row();
                $nama = $result->nama; // Assign fetched 'nama' to the variable $nama
            } else {
                // Handle the case where 'idakun' is not found in 'akun'
                $nama = ''; // Set a default value or handle accordingly
            }*/
