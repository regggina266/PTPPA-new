        ...
        <div class="col-lg-6 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Edit Data Level</h4>
                            <form action="<?= base_url('Leveladm/proses_edit') ?>" method="post">
                                <?php foreach ($level as $row) : ?>
                                    <input type="hidden" name="idlevel" value="<?= $row->idlevel; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level_k" class="form-control" id="level_k">
                                            <option value="<?= $row->idlevel; ?>"><?= $row->idlevel; ?></option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">Status Level </label>
                                        <select name="status_level" class="form-control" id="status_level">
                                            <option value="<?= $row->idlevel; ?>"><?= $row->idlevel; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="namadepartemen" class="form-control" id="namadepartemen">
                                            <option value="">Select</option>
                                            <!-- <?php foreach ($rows as $row) : ?>
                                                <option value="<?= $row->iddepartemen; ?>"><?= $row->namadepartemen; ?></option>
                                            <?php endforeach ?> -->
