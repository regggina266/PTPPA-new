...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- order list area start -->
         <div class="card mt-5">
                <div class="card-body">
                    <a href="<?php echo base_url('Laporanadm/tambah') ?>"><button type="button"  class="btn btn-danger"  data-bs-target="#addlevel"><i class="dripicons-plus"></i> + Tambah Laporan</button><br><br></a>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <ul class="d-flex justify-content-center">
                                                        ...
                                                        <li class="mr-3"><a href="<?php echo base_url('Generate/index/') ?>" ><i class="ti-printer" title="Print"></i></a></li>
                                                    </ul>
                                                 </td>
                                            </tr>
                                             </tbody>
