                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Akunms/proses_edit') ?>" method="post">
                                        <input type="hidden" name="idakun" value="<?=  $akun->idakun; ?>">
                                        <div class="form-group">
                                        <?php //print_r(echo $akun->idakun) ?> 
                                            <label for="example-text-input" class="col-form-label">Nama</label>
                                            <input class="form-control" type="text" value="<?= $akun->nama; ?>" name="nama" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">NRP</label>
                                            <input class="form-control" type="text" value="<?= $akun->NRP; ?>" name="NRP" id="example-text-input">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Password:</label>
                                            <input class="form-control" type="text" value="" name="password" id="example-text-input">
                                            <input type="hidden" name="password" value="<?= $akun->password; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label">Level Akun</label>
