                ...
                <div style="overflow: hidden;" class="menu-inner">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="<?= base_url('dashboardms') ?>" aria-expanded="true"><i class="ti-home"></i><span><b>Dashboard</b></span></a>
                            </li>
                            <li>
                                <a style="color: #fff !important" href="<?= base_url('akunms') ?>" aria-expanded="true"><i style="color: #fff !important" class="ti-user"></i><span><b>Akun</b></span></a>
                            </li>
                            <!-- <li>
