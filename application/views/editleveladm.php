                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Leveladm/proses_edit') ?>" method="post">
                                <?php foreach ($level as $row) : ?>  <?php endforeach; ?>
                                    <input type="hidden" name="idlevel" value="<?= $row->idlevel; ?>">
                                    
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Nama Level</label>
                                        <input class="form-control" type="text" value="<?= $row->level_k; ?>" name="level_k" id="example-text-input">                                
                                    </div>
                                    </div>                           
