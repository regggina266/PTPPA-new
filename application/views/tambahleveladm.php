                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('Leveladm/tambah_departemen'); ?>" method="post">
                                        <?php foreach ($level as $row) : ?>
                                        <input type="hidden" name="idlevel" value="<?= $row->idlevel; ?>"><?php endforeach; ?>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Nama Level</label>
                                                <input class="form-control" type="text" value="" id="example-text-input" name="level_k" required>
                                            </div>
