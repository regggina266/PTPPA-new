                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('Departemen/tambah_departemen'); ?>" method="post">
                                        ...
                                        <input type="hidden" name="iddepartemen" value="<?= $row->iddepartemen; ?>">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" value="" id="example-text-input" name="namadepartemen" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Nama Devisi</label>
                                                <input class="form-control" type="text" value="" id="example-text-input" name="devisi" required>
                                            </div>
